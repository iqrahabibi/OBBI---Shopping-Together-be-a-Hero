...
class CreatePurchasingOrderMasuksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('purchasing_order_masuks', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('purchasing_order_masuks');
    }
}
