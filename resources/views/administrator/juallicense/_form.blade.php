...
<div class="form-group {!! $errors->has('nik') ? 'has-error' : '' !!}">
	...
	<div class="col-md-10">
		@if(isset($data))
			{!! Form::text('nik', isset($data) ? $data->license_owner->nik : null, ['class'=>'form-control', 'readonly']) !!}
		@else
			{!! Form::text('nik', isset($data) ? $data->license_owner->nik : null, ['class'=>'form-control']) !!}
		@endif
...
<div class="form-group {!! $errors->has('nama_depan') ? 'has-error' : '' !!}">
	...
	<div class="col-md-10">
		{!! Form::text('nama_depan', !empty($data->license_owner) ? $data->license_owner->nama_depan : null, ['class'=>'form-control']) !!}
		<div class="form-control-focus"></div>
...
<div class="form-group {!! $errors->has('nama_tengah') ? 'has-error' : '' !!}">
	...
	<div class="col-md-10">
		{!! Form::text('nama_tengah', !empty($data->license_owner) ? $data->license_owner->nama_tengah : null, ['class'=>'form-control']) !!}
		<div class="form-control-focus"></div>
...
<div class="form-group {!! $errors->has('nama_belakang') ? 'has-error' : '' !!}">
	...
	<div class="col-md-10">
		{!! Form::text('nama_belakang', !empty($data->license_owner) ? $data->license_owner->nama_belakang : null, ['class'=>'form-control']) !!}
		<div class="form-control-focus"></div>
...
<div class="form-group {!! $errors->has('nama_lengkap') ? 'has-error' : '' !!}">
	...
	<div class="col-md-10">
		{!! Form::text('nama_lengkap', !empty($data->license_owner) ? $data->license_owner->nama_lengkap : null, ['class'=>'form-control']) !!}
		<div class="form-control-focus"></div>
...
<div class="form-group {!! $errors->has('tanggal_lahir') ? 'has-error' : '' !!}">
	...
	<div class="col-md-10">
		{!! Form::date('tanggal_lahir', !empty($data->license_owner) ? $data->license_owner->tanggal_lahir : null, ['class'=>'form-control']) !!}
		<div class="form-control-focus"></div>
...
<div class="form-group {!! $errors->has('agama_id') ? 'has-error' : '' !!}">
	...
	<div class="col-md-10">
		{!! Form::select('agama_id',[''=>'']+App\Model\Agama::pluck('nama_agama','id')->all(), !empty($data->license_owner) ? $data->license_owner->agama_id : null, ['class'=>'js-selectize', 'placeholder'=>'Pilih Agama']) !!}
		<div class="form-control-focus"></div>
...
<div class="form-group {!! $errors->has('status_pernikahan') ? 'has-error' : '' !!}">
	...
	<div class="col-md-10">
		{!! Form::text('status_pernikahan', !empty($data->license_owner) ? $data->license_owner->status_pernikahan : null, ['class'=>'form-control']) !!}
		<div class="form-control-focus"></div>
...
<div class="form-group {!! $errors->has('jenis_kelamin') ? 'has-error' : '' !!}">
	...
	<div class="col-md-10">
		<div class="md-radio-inline">
			...
			<div class="md-radio">
				{!! Form::radio('jenis_kelamin', 'Perempuan', !empty($data->license_owner) && $data->license_owner->jenis_kelamin == 'Perempuan' ? true : false, ['class'=>'md-radiobtn', 'id'=>'radio_perempuan']) !!}
...
<div class="form-group {!! $errors->has('alamat') ? 'has-error' : '' !!}">
	...
	<div class="col-md-10">
		{!! Form::text('alamat', !empty($data->license_owner) ? $data->license_owner->alamat : null, ['class'=>'form-control']) !!}
		<div class="form-control-focus"></div>
...
<div class="form-group {!! $errors->has('rt') ? 'has-error' : '' !!}">
	...
	<div class="col-md-10">
		{!! Form::text('rt', !empty($data->license_owner) ? $data->license_owner->rt : null, ['class'=>'form-control']) !!}
		<div class="form-control-focus"></div>
...
<div class="form-group {!! $errors->has('rw') ? 'has-error' : '' !!}">
	...
	<div class="col-md-10">
		{!! Form::text('rw', !empty($data->license_owner) ? $data->license_owner->rw : null, ['class'=>'form-control']) !!}
		<div class="form-control-focus"></div>
...
<div class="form-group {!! $errors->has('no_telp') ? 'has-error' : '' !!}">
	...
	<div class="col-md-10">
		{!! Form::text('no_telp', !empty($data->license_owner) ? $data->license_owner->no_telp : null, ['class'=>'form-control']) !!}
		<div class="form-control-focus"></div>
...
<div class="form-group {!! $errors->has('no_telp_2') ? 'has-error' : '' !!}">
	...
	<div class="col-md-10">
		{!! Form::text('no_telp_2', !empty($data->license_owner) ? $data->license_owner->no_telp_2 : null, ['class'=>'form-control']) !!}
		<div class="form-control-focus"></div>
...
<div class="form-group {!! $errors->has('file_ktp') ? 'has-error' : '' !!}">
	...
	<div class="col-md-10">
		{!! Form::file('file_ktp') !!}
		@if(!empty($data->license_owner) && $data->license_owner->file_ktp)
			{!!Html::image(config('app.api').'/storage'.$data->license_owner->file_ktp, null,['width'=>'300px','height'=>'300px'])!!}
		@endif
		<div class="form-control-focus"></div>
...
<div class="form-group {!! $errors->has('license_id') ? 'has-error' : '' !!}">
	...
	<div class="col-md-10">
		...
		@else
			{!! Form::select('license_id',[''=>'']+App\Model\License::list(), null,['class'=>'js-selectize', 'placeholder'=>'Pilih License']) !!}
		@endif
		<div class="form-control-focus"></div>
