		...
		<div class="portlet light">
			<div class="portlet-title">
				<div class="caption font-green">
					<span class="caption-subject bold uppercase">Ubah License</span>
				</div>
			</div>
			<div class="portlet-body form">
				{!! Form::model($data, ['route' => ['license.update', $data],'method' =>'patch', 'class'=>'form-horizontal margin-bottom-40', 'role'=>'form', 'files'=>'true'])!!}
					<div class="form-body">
						...
						<div class="form-group">
							{!! Form::label('wilayah', 'Wilayah Saat Ini', ['class'=>'col-md-2 control-label']) !!}
							<div class="col-md-10">
								{!! Form::text('wilayah', $wilayah, ['class'=>'form-control', 'disabled'=>'disabled']) !!}
							</div>
						</div>
						...
						@include('administrator.license._form', ['model' => $data])
					</div>
