		...
		<div class="portlet light">
			<div class="portlet-title">
				<div class="caption font-green">
					<span class="caption-subject bold uppercase">Tambah Kecamatan</span>
				</div>
			</div>
			<div class="portlet-body form">
				{!! Form::open(['route' => 'kecamatan.store', 'class'=>'form-horizontal margin-bottom-40', 'role'=>'form'])!!}
					<div class="form-body">
						...
						@include('administrator.kecamatan._form')
					</div>
