...
<section class="content-header">
  ...
  <div class="collapse" id="collapse-pdf">
      ...
      <form method="post" action="{{route('laporan.laporansaldoasik.cetak')}}" id="frm-pdf" target="_blank">
      {{csrf_field()}}
	  ...
	  <ol class="breadcrumb">
        ...
        <li class="active">Laporan Transaksi Saldo Asik</li>
    </ol>
</section>
